...
export default function StepVisaWithoutMM( props: {setStep: any} )  {
      ...
      <div className="space-y-8">
        <div>
          <h1 className="text-2xl font-bold text-gray-900 mb-6 leading-tight">
            You landed the job! <br/> That's what we live for.
          </h1>
          <h1 className="text-l font-bold text-gray-900 mb-6 leading-tight">
